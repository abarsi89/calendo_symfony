...
class RoleController extends AbstractController
{
    ...
    /**
     * @Route("/{roleId}", name="app_role_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{roleId}/edit", name="app_role_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{roleId}", name="app_role_delete", methods={"POST"})
     */
